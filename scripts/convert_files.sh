...
for sud_file in /workspace/input_sud_files/*.sud; do
  ...
  java -cp /workspace/x3/X3/src:/workspace/lib/commons-io-2.11.0.jar:/workspace/lib/guava-30.1.1-jre.jar org.pamguard.x3.sud.ConvertSUDToWAV "$sud_file" "$wav_file"
